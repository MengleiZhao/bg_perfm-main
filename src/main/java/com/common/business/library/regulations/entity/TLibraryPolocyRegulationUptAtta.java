...
@TableName("t_library_polocy_regulation_upt_atta")
public class TLibraryPolocyRegulationUptAtta extends Model<TLibraryPolocyRegulationUptAtta> implements EntityDao {
     ...
     * 政策法规修改附件表 主键值
     */
	@TableId(value="ID_U_A", type= IdType.AUTO)
