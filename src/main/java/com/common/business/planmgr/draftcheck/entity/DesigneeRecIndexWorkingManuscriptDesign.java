...
@TableName("designee_rec_index_working_manuscript_design")
public class DesigneeRecIndexWorkingManuscriptDesign extends Model<DesigneeRecIndexWorkingManuscriptDesign> {
