...
@TableName("bussiness_flow_pro_working_manuscript_design")
public class BussinessFlowProWorkingManuscriptDesign extends Model<BussinessFlowProWorkingManuscriptDesign> {
...
1-已完成
	...
	private TWorkingManuscriptDesignCheckRec tWorkingManuscriptDesignCheckRec;
