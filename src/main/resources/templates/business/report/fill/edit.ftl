<div class="row">
	...
	<div style="width: 100%;height:90%;margin: 0 auto;">
		<div style="width: 100%;height:100%;">
			<form id="upload_form" method="post" enctype="multipart/form-data" action="/tProEvalReportTemp/save?serviceType=template">
				<div style="width:100%;height:100%;padding-left: 10px;float: left;border:1px dashed #BFEDF0">
					<div style="padding-top: 10px;">
						<table>
							<tr>
								<td>
									<label id="nticeContentLabel">备注</label>
									<input type="textarea" class="form-control" name="researchContent" id="edit_remark"
										   placeholder="输入备注...">
								</td>
							</tr>
							<tr>
