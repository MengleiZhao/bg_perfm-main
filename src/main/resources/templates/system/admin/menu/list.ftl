                ...
                <div class="clearfix">
                    <div class="col-md-4">
                        <a class="btn btn-sm btn-primary" target="modal" modal="lg"
                           href="${request.contextPath}/menu/add">添加</a>
                    </div>
                </div>
...
<script type="text/javascript">
    $(function () {
        var table = $('#menu_tab').treegrid({
            ...
            collapsible: true,
            fitColumns: true,
            url: '${request.contextPath}/menu/getTreeGridMenu',
            method: 'get',
            idField: 'id',
            treeField: 'name',
            showFooter: true,
                    ...
                    },
                    {
                        ...
                        formatter:function(value){
                            ...
                            if (value != '000000000000000000'){
                                content = '<a class="btn btn-xs btn-info"  target="modal" modal="lg" href="${request.contextPath}/menu/edit/' + value + '">编辑</a>'
                                        + " &nbsp;"
                                        +'<a class="btn btn-xs btn-default" callback="reloadMenuList()" data-body="确认要删除吗？" target="ajaxTodo" href="${request.contextPath}/menu/delete/' + value + '">删除</a>'
