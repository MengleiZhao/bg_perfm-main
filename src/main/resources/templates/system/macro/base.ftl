...
<header class="main-header">
    <a href="index2.html" class="logo">
        <span class="logo-mini"><b>绩效管理平台</b></span>
        <span class="logo-lg"><b>绩效管理平台</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="${request.contextPath}/user/goModifyPwd/${user.id}" target="modal" modal="lg"  class="btn btn-default btn-flat">密码修改</a>
                            </div>
                            <div class="pull-right">
                                <a href="${request.contextPath}/logout" class="btn btn-default btn-flat">安全退出</a>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--富文本编辑器  开始：添加的顺序必须是config,再是all-->
<script src="adminlte/plugins/ueditor/ueditor.config.js"></script>
<script src="adminlte/plugins/ueditor/ueditor.all.js"></script>
<!--富文本编辑器  结束-->
